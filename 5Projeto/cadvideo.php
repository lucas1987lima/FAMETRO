...
include("conexao.php");
 ...
 $categoria="2";
 $sql = mysql_query("INSERT INTO tabvideo (categoria,titulo,video,comentario) VALUES ('$categoria','$titulo','$video','$comentario')");
   if ($sql == 0)
   {
     echo "<script>alert('Falhou!');location='cadvideo.php';</script>";
   }
   else
   {
     echo "<script>alert('OK!');location='cadvideo.php';</script>";
   }
 }//fim if
...
<form method="post" action="?acao=cadastrar"">
  <table border="1" width="500" align="center">
   <tr>
     <td colspan="2"><font color="#FFFFFF"><h1><center>CADASTRAR V&Iacute;DEO</center></h1></font></td>
   </tr>
   <tr>
   ...
   <tr>
     <td colspan="2" bgcolor="#FFFFFF"><input type="file" name="video"></td>
   </tr>
   <tr>
   <tr>
