...
<table align='center' width='1320' height='35' border='0' bordercolor="red" BGCOLOR='black'>
	 <td width="1320" height="20" align='center' ><font face='Comic Sans MS'>
	  ...
	  <a href="uploadarquivo.php" class="classe1" style='text-decoration:none'><font color="white">Upload Arquivo</a>&nbsp;&nbsp;
...
<!-- Upload das imagens -->
 ...
 <center><font color='red'><br/>Click em SELECIONAR ARQUIVO para adicionar um arquivo, depois em Enviar.<br/><br/><br/>
 Título do arquivo:&nbsp;<input type="text" name="titulo" size="34"><br/><br/>
 
<form action="uploadarquivo2.php" method="post" enctype="multipart/form-data">
