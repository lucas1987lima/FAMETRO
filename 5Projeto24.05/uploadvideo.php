...
<center><font color='red'><br/><br/><br/>
 <form method="POST" action="uploadvideo2.php">
  <table border="1" width="500" align="center">  
   <tr>
     <td colspan="2"><h3><center><font color='red'>CADASTRAR VÍDEO:</center></h1></td>
   </tr>
   <tr>
     <td width="155"><font color='red'>TÍTULO DO VÍDEO:</td>
     <td><input type="text" name="titulo" size="52"></td>
   </tr>
   <tr>
     <td colspan="2" ><font color='red'>URL DO VÍDEO:&nbsp;<input type="text" name="arquivo" size="57"></td>
   </tr> 
   <tr>
