...
if ($acao == 'pesquisar')
{
 $sql = mysql_query("SELECT * FROM tabalunos WHERE matricula = $matpesquisada");
}
...
<body onload="document.formpesq.matpesquisada.focus();">
<form name="formpesq" method="post" action="?acao=pesquisar">
<div align="center">
Matricula a ser Pesquisada <input type="text" name="matpesquisada" id="matpesquisada" size="15">
